...
<body>
	...
	<nav aria-label="breadcrumb" role="navigation">
		<ol class="breadcrumb">
			...
			<li class="breadcrumb-item active" aria-current="page">섭취식품</li>
		</ol>
	</nav>
	<div class="back">
		<div class="container">
				...
				<c:when test="${idx.count mod 2 eq 1 }">
					<div class="col-sm-6">
						<div class="row item">
							...
							<h3>${food.name }</h3><h4>수량 : ${eatlist[idx.count].cnt }</h4>	
								<div class="btn-group" role="group">
									<input type="text" value="${eatlist[idx.count].eatfoodcode }" hidden="hidden">
									<button type="button" class="btn btn-primary delBt" >삭제</button>
									<button type="button" class="btn btn-primary">수정</button><br>
								</div>
						</div>
					</div>
				</c:when>
