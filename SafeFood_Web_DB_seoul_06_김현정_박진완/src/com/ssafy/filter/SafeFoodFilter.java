...
public class SafeFoodFilter implements Filter {
	...
	public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException {
		...
		} else if(reqString.equals("/eatFoodAdd.mvc")) { // 회원 정보 수정완료
			controller.eatFoodAdd(req, res);
		} else if(reqString.equals("/eatFoodList.mvc")) { // 회원 정보 수정완료
			controller.eatFoodList(req, res);
		} else if(reqString.equals("/eatFoodDelete.mvc")) { // 회원 정보 수정완료
			controller.eatFoodDelete(req, res);
		} else if(reqString.equals("/eatFoodUpdate.mvc")) { // 회원 정보 수정완료
			controller.eatFoodUpdate(req, res);
		} else if(reqString.equals("/searchPassword.mvc")) {
			controller.searchPassword(req, res);
		} else if(reqString.equals("/searchPassForm.mvc")) {
			req.getRequestDispatcher("jsp/searchPass.jsp").forward(req, res);
		}
	}
